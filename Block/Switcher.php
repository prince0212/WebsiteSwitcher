...
namespace Deloitte\WebsiteSwitcher\Block;
...
class Switcher extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        \Magento\Store\Api\WebsiteRepositoryInterface $websiteModel,
        array $data = [],
    ...
    {
        $website = $this->_websiteModel->getById($this->getCurrentWebsiteId());
